...
<head>
    ...
    <title>MSPortfolio - WEB掲示板</title>
</head>
<body>
    <div class="container">
        <h1 class="app-title">WEB掲示板</h1>
        <div class="app-content">
            <img src="images/bulletinboard.jpg" alt="bulletinboard" width="480" height="260" class="app-image">
            <img src="images/bulletinboard2.jpg" alt="bulletinboard2" width="200" height="240" class="app-image">
            <img src="images/bulletinboard3.jpg" alt="bulletinboard3" width="360" height="220" class="app-image">
