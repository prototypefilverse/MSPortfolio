                ...
                <div class="container">
                    ...
                    <div class="profile-container">
                        ...
                        <div class="profile-text">
                          <p>　イニシャル M.S。20代は主に接客業、30代は製造業に従事。物事の仕組みについて知見を持ちたく、html/css、Ruby、Javaなどを勉強後、2023年春頃にエンジニアへの転職活動開始。40歳の2024年3月、株式会社クオーレテックの社員としてサービスデスクとしてSES初業務につく。</p>
                            <ul class="about-list">
                              ...
                              <li>学習方針：データベースを使用したWEBサイトを作成しリリースまで完了する</li>
                           </ul>
                        </div>
                    </div>
                </div>
